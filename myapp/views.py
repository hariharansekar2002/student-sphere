...
def groups_list(request):
    ...
    return render(request,'student_groups.html',{'permission':perm,'cse_two':cse_two,'cse_three':cse_three,'cse_four':cse_four})
...
def notes_folder(request,pk):
    ...
    return render(request, 'notes_folder.html', {'form': form, 'group_name': group_name, 'folder_name': linked_folders,'pk':pk,'permission':permission })
...
def notes(request,group_id,folder_id):
    ...
    return render(request, 'notes.html', {'notes': form, 'file_list': files_list,'permission':permission,'group_id':group_id,'folder_id':folder_id})
...
def groupmembers():
    ...
    new_student = []
    for student in student_list:
        if not student.groups.filter(name = 'Cse II') and not student.groups.filter(name = 'Cse III') and not student.groups.filter(name = 'Cse IV'):
...
def Cse_second(request):
    ...
    return render(request,'Csetwo.html',{'members_list': groupmembers(),'remove_memeber_list':remove_members_list()})
...
def Cse_third(request):
    ...
    return render(request,'Csethree.html',{'members_list': groupmembers(),'remove_memeber_list':remove_members_list()})
...
def Cse_four(request):
    ...
    return render(request,'Csefour.html',{'members_list': groupmembers(),'remove_memeber_list':remove_members_list()})
